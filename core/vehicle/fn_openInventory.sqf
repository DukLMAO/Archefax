...
//_crate = ["Land_CargoBox_V1_F"];
//if(isNull _vehicle OR !(_vehicle isKindOf "Car" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F") OR !(TypeOf _vehicle in _crate)) exitWith {}; //Either a null or invalid vehicle type.
