...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","rye_1","hops_1","yeast_1","shroom_1","lsd_1","lithium_1","grape_1","grape_2","grape_3","grape_4","grape_5","gold_1","ephedra_1","phosphorus_1","corn_1","yeast_1","sugar_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["shroom_1"]): {"mushroom"};
	case (_zone in ["lsd_1"]): {"frog"};
	case (_zone in ["lsd_2"]): {"frog"};
	case (_zone in ["wood_1"]): {"lumber"};
	case (_zone in ["wood_2"]): {"lumber"};
	case (_zone in ["ephedra_1"]): {"ephedra"};
	case (_zone in ["lithium_1"]): {"lithium"};
	case (_zone in ["phosphorus_1"]): {"phosphorus"};
	case (_zone in ["sugar_1"]): {"sugar"};
	case (_zone in ["yeast_1"]): {"yeast"};
	case (_zone in ["corn_1"]): {"corn"};
	case (_zone in ["gold_1"]): {"goldu"};
	case (_zone in ["grape_1","grape_2","grape_3","grape_4","grape_5"]): {"grape"};
	default {""};
};
