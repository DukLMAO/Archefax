...
[[[0,1],"STR_GNOTF_CaptureAttempte",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;
...
[[[0,1],"STR_GNOTF_CaptureSuccesste",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;
