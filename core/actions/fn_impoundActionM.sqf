#include <macro.h>
/*
	File: fn_impoundActionM.sqf
	Author: Bryan "Tonic" Boardwine
	Edited by Ethan for Medics and Impound Lots
	Description:
...
[[0,"STR_NOTF_BeingImpoundedM",true,[SEL(SEL(_vehicleData,0),1),_vehicleName]],"life_fnc_broadcast",true,false] call life_fnc_MP;
