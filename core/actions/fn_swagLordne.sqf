...
[[[0,1],"STR_GNOTF_CaptureAttemptne",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;

if(!isNil "_action" && {!_action}) exitWith {titleText[localize "STR_GNOTF_CaptureCancel","PLAIN"];};
//life_action_inUse = true;

/*_markername = str(getPos _hideout);
_gangname2 = formatText["Contested"];
...
[[[0,1],"STR_GNOTF_CaptureSuccesstne",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;
