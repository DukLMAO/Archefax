...
_itemInfo = switch (_type) do {
	...
	case "shroom": {["mushroom","magic_mushroom",10,(localize "STR_Process_Shroom")];};
	case "lsd": {["frog","frog_lsd",10,(localize "STR_Process_Lsd")];};
	//case "meth": {["methu","meth",100,(localize "STR_Process_Meth")];};
	...
	case "cigarette": {["tobacco","cigarette",1,(localize "STR_Process_Cigarette")];};
	case "wine": {["grape","wine",1,(localize "STR_Process_Wine")];};
	case "crack": {["cocaine_processed","crack",300,(localize "STR_Process_Crack")];};
	case "gold": {["goldu","goldp",300,(localize "STR_Process_Gold")];};
	case "pallet": {["lumber","pallet",300,(localize "STR_Process_pallet")];};
	default {[];};
};
...
if(_vendor in [mari_processor,coke_processor,heroin_processor,shroom_processor,lsd_processor]) then {
	_hasLicense = true;
} else {
