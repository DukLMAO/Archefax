...
[[[0,1],"STR_GNOTF_CaptureAttemptw",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;
...
[[[0,1],"STR_GNOTF_CaptureSuccesstw",true,[name player,(group player) getVariable "gang_name"]],"life_fnc_broadcast",true,false] call life_fnc_MP;
