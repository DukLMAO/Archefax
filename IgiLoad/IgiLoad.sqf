...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_repair_F","C_Offroad_01_F","B_G_Offroad_01_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "C_Van_01_transport_F"];
	...
	IL_Supported_Cargo_NonVeh_Offroad = IL_Supported_Veh_Ammo;// - ["Land_WaterTank_F"];
	...
	IL_Supported_Cargo_NonVeh_VAN = IL_Supported_Veh_Ammo;
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD;
	IL_Supported_Cargo_NonVeh_HEMTT = IL_Supported_Veh_Ammo;
