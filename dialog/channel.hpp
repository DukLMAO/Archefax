...
class controls {
		...
		{
			idc = -1;
			text = "You are about to send a server-wide news message. Zero tolerance for trolling or rude behaviour. Role-play is required. Trolling will result in an immediate 2-week or Permanent Ban.";
			x = 0.1;
            y = 0.5;
			w = 0.5;
			h = 0.3;
